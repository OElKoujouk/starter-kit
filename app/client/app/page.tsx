        ...
        <main className="min-h-screen flex flex-col items-center justify-center p-8">
            ...
            <div className="text-center max-w-2xl mx-auto animate-fade-in">
                ...
                <p className="text-lg text-slate-600 mb-8 leading-relaxed">
                    Next.js 15 + Express + Prisma + Tailwind 4
                    <br />
                    <span className="text-slate-400">
                        Architecture Clean, TypeScript strict, prêt pour la production.
                    </span>
                </p>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a
                        ...
                        className="btn-secondary px-8 py-3 rounded-xl text-base flex items-center gap-2"
                    >
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                {[
                    ...
                    { name: "Express", emoji: "🚀" },
                    { name: "Prisma", emoji: "💎" },
                    { name: "Tailwind 4", emoji: "🎨" },
                ].map((tech) => (
                    <div
                        key={tech.name}
                        className="px-6 py-4 rounded-xl bg-white border border-slate-200 shadow-sm hover:shadow-md transition-shadow"
                    >
